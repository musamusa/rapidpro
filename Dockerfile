...
LABEL org.label-schema.build-date=$BUILD_DATE \
        org.label-schema.name="Community Connect" \
        org.label-schema.description="Unlocking Insights and Engagement." \
        org.label-schema.url="https://www.communityconnect.com/" \
        org.label-schema.vcs-ref=$VCS_REF \
        org.label-schema.vcs-url="https://github.com/greatnonprofits-nfp/rapidpro" \
        org.label-schema.vendor="Community Connect" \
...
RUN set -ex \
        ...
        && LIBRARY_PATH=/lib:/usr/lib pip install -r /rapidpro/pip-freeze.txt \
        && runDeps="$( \
...
COPY static/* /rapidpro/sitestatic/
