  ...
  new class Flow
    ...
    constructor: ->
      ...
      @actions = [
        ...
        { type:'sf_export', name:'Salesforce Export', verbose_name:'Export data to Salesforce', icon: 'icon-cloud', filter:[TEXT] }
      ...
      @operators = [
        ...
        { type: 'image', name: 'Has an image', verbose_name:'has an image', operands: 0, filter: [TEXT] }
